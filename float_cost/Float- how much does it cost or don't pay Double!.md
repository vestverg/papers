...
$\overbrace{\boxed{S}}^{\text{sign}} \overbrace{\boxed{\hspace{2em}E\hspace{2em}}}^{\text{exponent}} \overbrace{\boxed{\hspace{5em}M\hspace{5em}}}^{\text{mantissa}}$
$\boxed{0} \boxed{01111100} \boxed{01000000000000000000000}$

$\underbrace{\hspace{16em}}_{\text{32 bits}}$
...
The value of a normalized number is calculated as: $\text{value} = (-1)^{\text{sign}} \times 2^{E-127} \times \left(1 + \sum_{i=1}^{23} b_{23-i}2^{-i}\right)$
...
$\begin{array}{rcl}
\text{bit positions:} & 31 \cdots 23 & 22 \cdots 0 \\
\text{value} = 0.15625 & &
\end{array}$
